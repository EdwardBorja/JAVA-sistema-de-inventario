 ...
 * @author edward
 */
public class Conconsigna extends javax.swing.JFrame {
...
timer.start(); 
	...
	rs = stmt.executeQuery("SELECT * FROM consignacion where `No_parte` like '%"+Parte+"%' ");
    ...
    public void BuscaDescripcion(){
	 ...
	 rs = stmt.executeQuery("SELECT * FROM consignacion where `descripcion` like '%"+Descripcion+"%' ");
   ...
   Operacion();
	...
	rs = stmt.executeQuery("SELECT * FROM consignacion where `marca` like '%"+Marca+"%' ");
   ...
   Operacion();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 570, 102, -1));
        ...
        jPanel1.add(parte, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 50, 210, -1));
        ...
        jPanel1.add(descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 110, 210, -1));
        ...
        jPanel1.add(marca, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 170, 210, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Marca:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 150, -1, -1));
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/search.png"))); // NOI18N
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 40, -1, -1));

        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/search.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/search.png"))); // NOI18N
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 160, -1, -1));
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 570, 160, -1));
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Conconsigna.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   if (evt.getKeyCode()==KeyEvent.VK_ENTER){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conconsigna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Conconsigna().setVisible(true);
            }
        });
    }
