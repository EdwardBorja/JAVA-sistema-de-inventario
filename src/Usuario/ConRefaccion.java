 ...
 * @author edward
 */
public class ConRefaccion extends javax.swing.JFrame {
...
timer.start(); 
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ConRefaccion.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   if (evt.getKeyCode()==KeyEvent.VK_ENTER){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConRefaccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConRefaccion().setVisible(true);
            }
        });
    }
