 ...
 * @author edward
 */
public class ConHerramientas extends javax.swing.JFrame {
...
timer.start(); 
    ...
    public void BuscaDescripcion(){
        ...
        try{
           ...
           stmt = cn.createStatement();
            ...
            rs = stmt.executeQuery("SELECT * FROM herramientas where `descripcion` like '%"+Descripcion+"%' ");
     ...
     public void BuscaParte(){
        ...
        try{
           ...
           stmt = cn.createStatement();
            ...
            rs = stmt.executeQuery("SELECT * FROM herramientas where `No_parte` like '%"+Parte+"%' ");
   ...
   Operacion();
    ...
    public void SumaExistencia() {
        ...
        for (int i = 0; i <= (fila); i++) {
            sumatoria = Integer.parseInt(String.valueOf(jTable1.getValueAt(i, 4)));
            valor += sumatoria;
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 570, 120, -1));
        ...
        jPanel1.add(descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 170, 210, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Descripcion:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 150, -1, -1));
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, 160, -1));
        ...
        jLabel7.setText("No_parte:");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 100, -1, -1));
        ...
        jPanel1.add(parte, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 120, 210, -1));
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ConHerramientas.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 if (evt.getKeyCode()==KeyEvent.VK_ENTER){
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if(parte.getText().equals("") && descripcion.getText().equals("")){JOptionPane.showMessageDialog(null, "Ingresa Datos");
        }else{

            if(parte.getText().isEmpty() ){
                BuscaDescripcion();
            }
            else{
                BuscaParte();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConHerramientas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConHerramientas().setVisible(true);
            }
        });
    }
