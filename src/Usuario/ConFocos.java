 ...
 * @author edward
 */
public class ConFocos extends javax.swing.JFrame {
...
timer.start(); 
    ...
    public void BuscaParte(){
        ...
        try{
           ...
           stmt = cn.createStatement();
	            ...
	            rs = stmt.executeQuery("SELECT * FROM focos where `No_parte` like '%"+Parte+"%' ");
    ...
    public void BuscaDescripcion(){
        ...
        try{
           ...
           stmt = cn.createStatement();
            ...
            rs = stmt.executeQuery("SELECT * FROM focos where `Descripcion` like '%"+Descripcion+"%' ");
    ...
    private void initComponents() {
        ...
        jPanel1.add(parte, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 120, 210, -1));
        ...
        jPanel1.add(descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 180, 210, -1));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 160, -1, -1));
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 160, 160, -1));
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
           ...
           JOptionPane.showMessageDialog(null,"No hay ninguna impresora conectada");
        }
...
if (evt.getKeyCode()==KeyEvent.VK_ENTER){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConFocos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
