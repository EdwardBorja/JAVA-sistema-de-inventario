...
package ventanas;
import Busqueda.BuscaHerramienta;
...
timer.start(); 
    ...
    public void actualizar(){
     //ACTUALIZA TA LABLA
        ...
        try{
           ...
           rs = stmt.executeQuery("SELECT * FROM herramientas order by No_parte asc");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, 220, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 0));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/maintenance_128.png"))); // NOI18N
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 1105, 332));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 570, 102, 41));
        ...
        labelHora.setText(".");
        jPanel1.add(labelHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 98, -1));
        ...
        jPanel1.add(descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 40, 230, -1));
        ...
        jPanel1.add(entrada, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 100, 230, -1));
        ...
        jPanel1.add(salida, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 100, 230, -1));

        jLabel5.setBackground(new java.awt.Color(255, 255, 255));
        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Salida de producto:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 80, -1, -1));

        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/borrador.png"))); // NOI18N
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 90, 189, -1));

        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/agrega32.png"))); // NOI18N
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 570, -1, -1));

        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/edita.png"))); // NOI18N
        jButton7.setText("Modificar registro");
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 570, -1, -1));

        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/eliminar.png"))); // NOI18N
        ...
        jPanel1.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 570, -1, -1));
        ...
        jPanel1.add(parte, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 40, 230, -1));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 160, -1, -1));

        Textoex.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        Textoex.setForeground(new java.awt.Color(255, 255, 255));
        Textoex.setText("_");
        jPanel1.add(Textoex, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 160, 50, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Fecha:");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 160, -1, -1));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if(parte.getText().equals("") || descripcion.getText().equals("") || entrada.getText().equals("")|| salida.getText().equals("")){JOptionPane.showMessageDialog(null,"Hay campos vacios");
            ...
            String Parte,Descripcion,Entrada,Salida,Fecha;
		...
		rs = stmt.executeQuery("SELECT * FROM herramientas WHERE `No_parte`='" + Parte + "' ");
         
	   if(!rs.next()){
                stmt.executeUpdate("INSERT INTO herramientas VALUES ( '" + Parte + "','" + Descripcion + "','" + Entrada + "','" + Salida + "','" + Entrada + "','" + Fecha + "')");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
             ...
             if(parte.getText().equals("") ||descripcion.getText().equals("") || entrada.getText().equals("")|| salida.getText().equals("") ){JOptionPane.showMessageDialog(null,"Selecciona un registro de la tabla");
            ...
            if( x == JOptionPane.YES_OPTION){
                ...
                String Parte,Descripcion,Entrada,Salida,Existencias,Fecha;
         ...
         try{
          stmt.executeUpdate("UPDATE herramientas set `No_parte`='"+Parte+"',`descripcion`='"+Descripcion+"',`entrada`='"+Entrada+"'+`entrada`,`salida`=`salida`+'"+Salida+"',`existencias`=`existencias`+'"+Entrada+"'-'"+Salida+"',`fecha`='"+Fecha+"' WHERE( `No_parte`='"+Parte+"')");
    ...
    try {
         ...
         try{
         	   stmt.executeUpdate("DELETE FROM `herramientas` WHERE (`No_parte`='" + parte.getText() + "')");
...
//     SumaEntradaSalida();
    ...
    private void jMenu4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu4MouseClicked
       BuscaHerramienta bh= new BuscaHerramienta();
       bh.setVisible(true);
