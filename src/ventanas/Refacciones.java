...
import Busqueda.BuscaRefaccion;
...
timer.start(); 
     ...
     //ACTUALIZA TA LABLA
        ...
        try{
           ...
           rs = stmt.executeQuery("SELECT * FROM refacciones order by No_refaccion asc");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 230, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 0));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/refaccion.png"))); // NOI18N
        jLabel1.setText("Refacciones");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 235, 1105, 332));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1043, 578, 102, 41));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 110, 216, 30));
        ...
        jPanel1.add(entrada, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 116, 216, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Entrada de producto:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 95, -1, -1));
        ...
        jPanel1.add(parte, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 54, 216, -1));
        ...
        jPanel1.add(descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(669, 54, 216, -1));
        ...
        jPanel1.add(salida, new org.netbeans.lib.awtextra.AbsoluteConstraints(669, 116, 216, -1));
        ...
        jPanel1.add(marca, new org.netbeans.lib.awtextra.AbsoluteConstraints(929, 54, 216, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Marca:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(929, 33, -1, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Descripcion:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(669, 33, -1, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Salida de producto:");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(669, 95, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("No_parte:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 33, -1, -1));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(314, 578, 178, -1));
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 578, 178, -1));
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(706, 578, 178, -1));
        ...
        Textoex.setText("_");
        jPanel1.add(Textoex, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 180, 50, -1));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 180, -1, -1));
        ...
        jMenu5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/Iconos/search.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if(parte.getText().equals("") || descripcion.getText().equals("")|| marca.getText().equals("")|| entrada.getText().equals("")|| salida.getText().equals("")){JOptionPane.showMessageDialog(null,"Hay campos vacios");
           ...
           try {
            ...
            rs = stmt.executeQuery("SELECT * FROM refacciones WHERE `No_refaccion`='" + Parte + "' ");


           
            if(!rs.next()){
   		stmt.executeUpdate("INSERT INTO refacciones VALUES ( '" + Parte + "','" + Descripcion + "','" + Marca + "','" + Entrada + "','" + Salida + "','" + Entrada + "','" + Fecha + "')");
    ...
    try {
         ...
         try{
          stmt.executeUpdate("UPDATE refacciones set `No_refaccion`='"+Parte+"',`descripcion`='"+Descripcion+"',`marca`='"+Marca+"',`entrada`='"+Entrada+"'+`entrada`,`salida`=`salida`+'"+Salida+"',`existencias`=`existencias`+'"+Entrada+"'-'"+Salida+"',`fecha`='"+Fecha+"' WHERE( `No_refaccion`='"+ parte.getText() + "')");
    ...
    try {
         ...
         try{
        stmt.executeUpdate("DELETE FROM `refacciones` WHERE (`No_refaccion`='" + parte.getText() + "')");
...
//        SumaEntradaSalida();
    ...
    private void jMenu5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu5MouseClicked
        BuscaRefaccion br=new BuscaRefaccion(); 
        br.setVisible(true);
