 ...
 * @author edward
 */
public class BuscaRefaccion extends javax.swing.JFrame {
...
timer.start(); 
    ...
    public void BuscaParte(){
        ...
        try{
           ...
           stmt = cn.createStatement();
            ...
            rs = stmt.executeQuery("SELECT * FROM refacciones where `No_refaccion` like '%"+Refaccion+"%' ");
    ...
    public void BuscaDescripcion(){
        ...
        try{
           ...
           stmt = cn.createStatement();
            ...
            rs = stmt.executeQuery("SELECT * FROM refacciones where `descripcion` like '%"+Descripcion+"%' ");
     ...
     public void BuscaMarca(){
        ...
        try{
           ...
           stmt = cn.createStatement();
            ...
            rs = stmt.executeQuery("SELECT * FROM refacciones where `marca` like '%"+Marca+"%' ");
    ...
    private void initComponents() {
        ...
        setTitle("Búsqueda de Refacciones");
        setResizable(false);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(BuscaRefaccion.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   if (evt.getKeyCode()==KeyEvent.VK_ENTER){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaRefaccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaRefaccion().setVisible(true);
            }
        });
    }
