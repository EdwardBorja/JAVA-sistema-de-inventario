 ...
 * @author edward
 */
public class BuscaFoco extends javax.swing.JFrame {
...
if (evt.getKeyCode()==KeyEvent.VK_ENTER){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaFoco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
