 ...
 * @author edward
 */
public class BuscaHerramienta extends javax.swing.JFrame {
...
timer.start(); 
   ...
   Operacion();
    ...
    private void initComponents() {
        ...
        setTitle("Búsqueda de Herramientas");
        setResizable(false);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(BuscaHerramienta.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 if (evt.getKeyCode()==KeyEvent.VK_ENTER){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaHerramienta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaHerramienta().setVisible(true);
            }
        });
    }
