 ...
 * @author edward
 */
public class BuscaUnidad extends javax.swing.JFrame {
...
//        jLabel9.setText(String.valueOf(valor));
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(BuscaUnidad.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   ObtenerDatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaUnidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaUnidad().setVisible(true);
            }
        });
    }
