 ...
 * @author edward
 */
public class BuscaRelacion extends javax.swing.JFrame {
  ...
  public void actualizar(){
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(BuscaRelacion.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  ObtenerDatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaRelacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaRelacion().setVisible(true);
            }
        });
    }
